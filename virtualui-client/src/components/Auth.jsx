...
import { TbX, TbLogin2, TbSettings, TbCopy, TbDownload } from "react-icons/tb";
            ...
            >
                <div className='fixed inset-0 flex items-center justify-center bg-black/70 backdrop-blur-sm z-50 p-4'>
                    <motion.div
                        ...
                        className="relative flex flex-col sm:flex-row w-full max-w-[880px] max-h-[90vh] overflow-y-auto rounded-2xl border border-[#3be8ff]/10 shadow-[0_40px_80px_rgba(0,0,0,0.8)]"
                    >
                        <button
                            onClick={() => onClose?.()}
                        ...
                        <div className='sm:w-[52%] bg-gradient-to-br from-[#03181c] to-[#041e24] p-6 sm:p-10 relative overflow-hidden'>
                            <div className="absolute -top-16 -left-16 w-64 h-64 rounded-full bg-[radial-gradient(circle,rgba(59,232,255,0.08)_0%,transparent_70%)] pointer-events-none"></div>
                            ...
                            >
                                <div className='w-9 h-9 rounded-xl bg-gradient-to-br from-[#3be8ff] to-[#0ab5d4] flex items-center justify-center'>
                                    <SiValorant size={17} color="#051c20" />
                                </div>

                                <span
                                    className='tracking-tight text-xl font-bold text-[#e8f8fa]'
                            ...
                            <div className='flex sm:flex-col gap-2 sm:gap-1 overflow-x-auto sm:overflow-x-visible pb-2 sm:pb-0 -mx-1 px-1'>
                                {steps.map((item, i) => (
                                    <motion.div
                                        key={i}
                                        className={`shrink-0 sm:shrink p-1.5 flex items-start gap-3 py-2.5 rounded-xl border transition-all duration-300 min-w-[200px] sm:min-w-0 ${
                                            active === i
                                                ? 'bg-[#3be8ff]/[0.07] border-[#3be8ff]'
                                    ...
                                    >
                                        <div
                                            className={`min-w-[28px] h-7 rounded-lg flex items-center justify-center border transition-all duration-300 ${
                                                active === i
                                                    ? "bg-gradient-to-br from-[#3be8ff] to-[#0ab5d4]"
                                                    : "border-transparent bg-[#3be8ff]/[0.08] border-[#3be8ff]/20"
                                            }`}
                                        >
                                            <item.icon
                                                size={17}
                                        ...
                                        <div>
                                            <p
                                                className={`text-[12.5px] font-semibold transition-colors duration-300 whitespace-nowrap sm:whitespace-normal ${
                                                    active === i
                                                        ? 'text-[#d4f5fa]'
                                                        : 'text-white/55'
                                                }`}
                        ...
                        >
                            ...
                            <div className="relative z-10 w-full max-w-[280px] sm:max-w-[260px] text-center mx-auto">
                                ...
                                <h3
                                    className="text-xl sm:text-2xl font-bold text-[#e4f6f8] tracking-tight mb-2"
                                    style={{ fontFamily: 'inherit' }}
                                >
                                    Welcome
                                </h3>
